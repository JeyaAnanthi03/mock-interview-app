...
export const RecordAnswer = ({
  ...
  const recordNewAnswer = () => {
    setUserAnswer("");
    // Defensive: Only call stopSpeechToText if recording is active
    if (isRecording && typeof stopSpeechToText === "function") {
      try {
        stopSpeechToText();
      } catch (err) {
        toast.error("Failed to stop speech recognition. Try again.");
        console.error("stopSpeechToText error:", err);
      }
    }
    startSpeechToText();
  };
